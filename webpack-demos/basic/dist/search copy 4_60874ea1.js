...
/******/ 		return __webpack_require__.p + "" + ({}[chunkId]||chunkId) + "_" + {"10":"49861a33"}[chunkId] + ".js"
/******/ 	}
/******/
...
function (_React$Component) {
  ...
  _createClass(Search, [{
    ...
    value: function loadComponent() {
      ...
      __webpack_require__.e(/* import() */ 10).then(__webpack_require__.bind(null, 345)).then(function (Text) {
        _this2.setState({
          Text: Text["default"]
        });
      });
...
react_domfrom_dll_reference_library_dll_default.a.render(reactfrom_dll_reference_library_dll_default.a.createElement(search_copy_4_Search, null), document.getElementById('root'));
