...
/******/ 		return __webpack_require__.p + "" + ({}[chunkId]||chunkId) + "_" + {"14":"e6dfb1bd"}[chunkId] + ".js"
/******/ 	}
/******/
...
var search = __webpack_require__(342);
...
function (_React$Component) {
  ...
  _createClass(Search, [{
    ...
    value: function loadComponent() {
      ...
      __webpack_require__.e(/* import() */ 14).then(__webpack_require__.bind(null, 349)).then(function (Text) {
        _this2.setState({
          Text: Text["default"]
        });
      });
...
react_domfrom_dll_reference_library_dll_default.a.render(reactfrom_dll_reference_library_dll_default.a.createElement(search_Search, null), document.getElementById('root'));
