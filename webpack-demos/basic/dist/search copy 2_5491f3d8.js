...
/******/ 		return __webpack_require__.p + "" + ({}[chunkId]||chunkId) + "_" + {"8":"e6a22bd7"}[chunkId] + ".js"
/******/ 	}
/******/
...
// CONCATENATED MODULE: ./src/search copy 2/images/wechat.png
/* harmony default export */ var wechat = (__webpack_require__.p + "wechat_d8fb886b.png");
// CONCATENATED MODULE: ./src/search copy 2/tree-shaking.js
function a() {
...
// EXTERNAL MODULE: ./src/search copy 2/search.less
var search = __webpack_require__(336);

// CONCATENATED MODULE: ./src/search copy 2/index.js
...
function (_React$Component) {
  ...
  _createClass(Search, [{
    ...
    value: function loadComponent() {
      ...
      __webpack_require__.e(/* import() */ 8).then(__webpack_require__.bind(null, 343)).then(function (Text) {
        _this2.setState({
          Text: Text["default"]
        });
      });
...
react_domfrom_dll_reference_library_dll_default.a.render(reactfrom_dll_reference_library_dll_default.a.createElement(search_copy_2_Search, null), document.getElementById('root'));
