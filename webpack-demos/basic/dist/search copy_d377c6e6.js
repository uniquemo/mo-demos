...
/******/ 		return __webpack_require__.p + "" + ({}[chunkId]||chunkId) + "_" + {"13":"f83df18a"}[chunkId] + ".js"
/******/ 	}
/******/
...
// CONCATENATED MODULE: ./src/search copy/images/wechat.png
/* harmony default export */ var wechat = (__webpack_require__.p + "wechat_d8fb886b.png");
// CONCATENATED MODULE: ./src/search copy/tree-shaking.js
function a() {
...
// EXTERNAL MODULE: ./src/search copy/search.less
var search = __webpack_require__(341);

// CONCATENATED MODULE: ./src/search copy/index.js
...
function (_React$Component) {
  ...
  _createClass(Search, [{
    ...
    value: function loadComponent() {
      ...
      __webpack_require__.e(/* import() */ 13).then(__webpack_require__.bind(null, 348)).then(function (Text) {
        _this2.setState({
          Text: Text["default"]
        });
      });
...
react_domfrom_dll_reference_library_dll_default.a.render(reactfrom_dll_reference_library_dll_default.a.createElement(search_copy_Search, null), document.getElementById('root'));
