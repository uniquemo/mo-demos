...
/******/ 		return __webpack_require__.p + "" + ({}[chunkId]||chunkId) + "_" + {"9":"8d104bdd"}[chunkId] + ".js"
/******/ 	}
/******/
...
function (_React$Component) {
  ...
  _createClass(Search, [{
    ...
    value: function loadComponent() {
      ...
      __webpack_require__.e(/* import() */ 9).then(__webpack_require__.bind(null, 344)).then(function (Text) {
        _this2.setState({
          Text: Text["default"]
        });
      });
...
react_domfrom_dll_reference_library_dll_default.a.render(reactfrom_dll_reference_library_dll_default.a.createElement(search_copy_3_Search, null), document.getElementById('root'));
