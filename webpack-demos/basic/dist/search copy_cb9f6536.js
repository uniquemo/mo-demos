...
/******/ 		return __webpack_require__.p + "" + ({}[chunkId]||chunkId) + "_" + {"13":"1932a8fd"}[chunkId] + ".js"
/******/ 	}
/******/
...
function (_React$Component) {
  ...
  _createClass(Search, [{
    ...
    value: function loadComponent() {
      ...
      __webpack_require__.e(/* import() */ 13).then(__webpack_require__.bind(null, 347)).then(function (Text) {
        _this2.setState({
          Text: Text["default"]
        });
      });
...
react_dom_production_min_default.a.render(react_production_min_default.a.createElement(search_copy_Search, null), document.getElementById('root'));
